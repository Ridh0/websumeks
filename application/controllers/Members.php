...
class Members extends CI_Controller
{
	...
	function riwayat_belanja()
	{
		...
		$data['record'] = $this->model_app->view_where_ordering('tb_paket_penjualan', array('id_pembeli' => $this->session->id_pengguna), 'id_penjualan', 'DESC');
	...
	function history()
	{
		...
		$data['record'] = $this->model_app->view_where_ordering('tb_paket_penjualan', array('id_pembeli' => $this->session->id_pengguna), 'id_penjualan', 'DESC');
		$this->template->load('home/template', 'home/paket/view_transaksi_laporan', $data);
	}
}
