        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-banner__img">
              <img class="img-fluid" src="<?= base_url('assets/templated/')?>img/banner/hero-banner.png" alt="">
            </div>
          </div>
        ...
        <div class="row no-gutters align-items-center">
          ...
          <div class="col-md-7">
            <div class="about__img">
              <img class="img-fluid" src="<?= base_url('assets/templated/')?>img/home/about.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="offer-single__img">
              <img class="img-fluid" src="<?= base_url('assets/templated/')?>img/home/offer.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center pt-xl-3 pb-xl-5">
          <div class="col-lg-6">
            <div class="solution__img text-center text-lg-left mb-4 mb-lg-0">
              <img class="img-fluid" src="<?= base_url('assets/templated/')?>img/home/solution.png" alt="">
            </div>
          </div>
          <div class="col-lg-6">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="card text-center card-pricing">
              <div class="card-pricing__header">
                ...
                <h1 class="card-pricing__price"><span>Rp</span><?= rupiah($row['harga_paket']) ?></h1>
              </div>
              ...
              <button class="button button-light">Buy Now</button></a>
        ...
        <div class="owl-carousel owl-theme testimonial">
          <div class="testimonial__item text-center">
            <div class="testimonial__img">
              <img src="<?= base_url('assets/templated/')?>img/testimonial/testimonial1.png" alt="">
            </div>
    ...
    <section class="clients_logo_area section-padding">
      <div class="container">
        <div class="clients_slider owl-carousel">
          <div class="item">
            <img src="<?= base_url('assets/templated/')?>img/clients-logo/c-logo-1.png" alt="">
          </div>
          <div class="item">
            <img src="<?= base_url('assets/templated/')?>img/clients-logo/c-logo-2.png" alt="">
          </div>
          <div class="item">
            <img src="<?= base_url('assets/templated/')?>img/clients-logo/c-logo-3.png" alt="">
          </div>
          <div class="item">
            <img src="<?= base_url('assets/templated/')?>img/clients-logo/c-logo-4.png" alt="">
          </div>
          <div class="item">
            <img src="<?= base_url('assets/templated/')?>img/clients-logo/c-logo-5.png" alt="">
          </div>
        </div>
      </div>
    </section>
