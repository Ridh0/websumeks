<div class="row">
  <div class="col-md-7 mx-auto">
    ...
    <div class="mb-3 text-center">
      ...
      <a target='_BLANK' class="btn btn-sm btn-success mt-3 mb-2" href="<?= base_url(); ?>paket/print_invoice/<?= $orders; ?>"><span class="glyphicon glyphicon-print"></span> Download Invoice</a>
      <br>
    </div>
