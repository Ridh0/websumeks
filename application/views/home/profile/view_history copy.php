...
<div class="block">
  <div class="container">
    <div class="row">
      <div class="ardcol-12 col-lg-3 d-flex">
              ...
              <tbody>
                ...
                foreach ($record as $row) {
                  ...
                  echo "<tr><td>$no</td>
                              ...
                              <td>
                                <a class='btn btn-primary btn-sm' title='Download' href='" . base_url() . "page/download/$row[kode_transaksi]' target='_BLANK'><small>Download</small></a>
                                <a class='btn btn-warning btn-sm' title='Rincian data pesanan' href='" . base_url() . "page/tracking_status/$row[kode_transaksi]' target='_BLANK'><small>Rincian</small></a>
                              </td>
                          </tr>";
                  $no++;
                }
