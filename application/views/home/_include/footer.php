<footer class="footer ">
    ...
    <div class="container">
      <div class="row row-grid align-items-center my-md">
        <div class="col-lg-6">
          <h3 class="text-primary font-weight-light mb-2">Selamat Datang Di Website Kami</h3>
          <h4 class="mb-0 font-weight-light">Selamat Menikmati</h4>
        </div>
