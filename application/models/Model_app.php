...
class Model_app extends CI_model
{
    ...
    {
        return $this->db->query("SELECT * FROM `tb_paket_penjualan` a where a.id_pembeli='$id' ORDER BY a.id_penjualan DESC");
    }
    ...
    {
        return $this->db->query("SELECT * FROM `tb_paket_penjualan` a ORDER BY a.id_penjualan DESC");
    }


    function orders_report_packing()
    {
        return $this->db->query("SELECT * FROM `tb_paket_penjualan` a where a.proses='3' ORDER BY a.id_penjualan DESC");
    }

    function orders_report_home($limit)
    {
        return $this->db->query("SELECT * FROM `tb_paket_penjualan` a ORDER BY a.id_penjualan DESC LIMIT $limit");
    }
